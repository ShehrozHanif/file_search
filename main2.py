# Only File Reading
# This script sets up an agent that can read and extract text from various file formats
...
file_path = os.path.abspath("files\check.pdf")  # Ensures it's absolute path
